...
export default function MainLayout() {
  ...
  return (
    ...
    >
      {/* TopAppBar */}
      <header className="bg-[#FDFCF0] dark:bg-stone-900 fixed top-0 left-0 w-full max-w-[100vw] z-50 flex justify-center items-center h-16 px-4 border-b border-[#E5E2D0] dark:border-stone-800 shadow-sm">
      ...
      {/* BottomNavBar */}
      <nav className="bg-[#FDFCF0]/95 dark:bg-stone-900/95 backdrop-blur-md fixed bottom-0 left-0 w-full z-50 flex justify-around items-center h-16 pb-safe border-t border-[#E5E2D0] dark:border-stone-800">
      ...
      {/* Footer */}
      <footer className="w-full flex flex-col items-center gap-4 px-8 pb-32 pt-12 bg-[#F4F1E1] dark:bg-stone-950 mt-auto">
